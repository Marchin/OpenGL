...
int main() {
	...
	}
	{
		...
		Texture matrix("Resources/matrix.jpg", GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR);
		...
		objectShader.Bind();
		objectShader.SetVec3("objectColor", glm::vec3(1.0f, 1.f, 1.f));
		...
		while (!glfwWindowShouldClose(window)) {
			...
			textureController.AddTexture(matrix);
